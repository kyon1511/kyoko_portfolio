export default function SkillsPage() {
  return (
    <div className="p-10 text-[#2b0934]">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">フロントエンド</h2>
      <ul className="list-disc list-inside mb-4">
        <li>Next.js (TypeScript, App Router)</li>
        <li>Tailwind CSS / shadcn/ui</li>
      </ul>

      <h2 className="text-xl font-semibold mt-6 mb-2">バックエンド</h2>
      <ul className="list-disc list-inside mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">その他</h2>
